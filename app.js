...
function nounAndAdjective (noun = 'cat', adjective = 'orange') {
  return (`The ${noun} is ${adjective}.`)
}


// console.log(nounAndAdjective('dog', 'silly'))
...
const reactionToPizza = pizza === 'tasty' ? 'yum' : 'yuck';

// console.log(reactionToPizza)
